import {
  ...
  NgForm,
  Validators
} from "./chunk-IPFPMHTH.js";
import {
  MAT_FORM_FIELD,
  MatFormField,
  MatFormFieldControl,
  MatFormFieldModule
} from "./chunk-XQC44I3G.js";
import {
  animate,
  keyframes,
  state,
...
} from "./chunk-ISOZY3NJ.js";
import {
  CommonModule,
  DOCUMENT,
  Location,
  NgClass
} from "./chunk-C42KWGJR.js";
import {
...
var _MatDateRangeInput = class _MatDateRangeInput {
  ...
  constructor(_changeDetectorRef, _elementRef, control, _dateAdapter, _formField) {
    ...
    this._formField = _formField;
    this._closedSubscription = Subscription.EMPTY;
    this.id = `mat-date-range-input-${nextUniqueId3++}`;
    this.focused = false;
